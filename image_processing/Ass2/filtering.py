...
def task_2_1_a():
	...
	#Produce the amplitude of the transform
	...
	misc.imsave('task2_1_a/filtered/filtered_original.png', image)
	misc.imsave('task2_1_a/filtered/filtered_low_pass.png', convolved_low)
	misc.imsave('task2_1_a/filtered/filtered_high_pass.png', convolved_high)
...
def task_2_1_c():
	...
	misc.imsave('hybrid_image.png', hybrid_image)
